...
def standardize_data(df, feature_var, target_var='Status_Encoded'):
    ...
    # --- Bagian untuk MENYIMPAN SCALER ---
    try:
        with open('scaler.pkl', 'wb') as file:
            pickle.dump(scaler, file)
        print("Scaler berhasil disimpan sebagai 'scaler.pkl'")
        # CEK UKURAN FILE SEGERA SETELAH DISIMPAN
        file_size_scaler = os.path.getsize('scaler.pkl')
...
try:
    ...
    print("Model berhasil disimpan sebagai 'student_performance_status.pkl'")
    # CEK UKURAN FILE SEGERA SETELAH DISIMPAN
    file_size_model = os.path.getsize('student_performance_status.pkl')
    ...
    elif file_size_model < 10000: # Asumsi model biasanya > 10KB
         print("PERINGATAN: File model sangat kecil. Mungkin ada masalah.")
except Exception as e:
    print(f"ERROR FATAL SAAT MENYIMPAN MODEL: {e}")

"""Simpan berkas requirements.txt"""

! pip freeze > requirements.txt

"""## Persiapan Data Untuk Dashboard (Tambahan)"""
